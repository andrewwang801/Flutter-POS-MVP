...
import '../common/services/xprinter_service.dart' as _i21;
import '../home/model/prep/prep_model.dart' as _i4;
import '../home/provider/order/order_state_notifier.dart' as _i16;
import '../home/provider/plu_details/plu_state_notifier.dart' as _i17;
...
import '../payment/provider/payment_state_notifier.dart' as _i18;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i16.OrderStateNotifier>(() => _i16.OrderStateNotifier(
      get<_i8.IOrderRepository>(), get<_i10.IPaymentRepository>()));
  gh.factory<_i17.PLUStateNotifier>(() => _i17.PLUStateNotifier(
      get<_i6.IMenuRepository>(), get<_i8.IOrderRepository>()));
  gh.factory<_i18.PaymentStateNotifer>(
      () => _i18.PaymentStateNotifer(get<_i10.IPaymentRepository>()));
  gh.factory<_i19.PrintController>(() => _i19.PrintController(
      get<_i12.IPrintRepository>(),
      get<_i10.IPaymentRepository>(),
      get<_i5.PrinterManager>()));
  gh.factory<_i20.PrinterStateNotifier>(() => _i20.PrinterStateNotifier(
      get<_i14.IPrinterRepository>(), get<_i5.PrinterManager>()));
  gh.factory<_i21.XPrinterService>(() =>
      _i21.XPrinterService(paymentRepository: get<_i10.IPaymentRepository>()));
  return get;
}
